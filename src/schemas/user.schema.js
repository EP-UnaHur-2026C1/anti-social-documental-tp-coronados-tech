...
const name = Joi.string()
  ...
  .messages({
    ...
    "string.pattern.base":
      "El nombre solo puede contener letras, acentos, ñ y espacios",
...
const lastName = Joi.string()
  ...
  .messages({
    ...
    "string.pattern.base":
      "El apellido solo puede contener letras, acentos, ñ y espacios",
...
const birthDate = Joi.date().iso().less("now").required().messages({
  "date.base":
    "La fecha de nacimiento debe ser una fecha válida (formato: YYYY-MM-DD, ej: 1988-11-07)",
  "date.format":
    "La fecha de nacimiento debe tener formato YYYY-MM-DD (ej: 1988-11-07)",
